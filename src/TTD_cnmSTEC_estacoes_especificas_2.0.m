...
%     t_fim1    = datenum(2025,8,22,3,06,0)- 678942;   % 22 Aug 03:06 (50 minutos)
    t_fim1    = datenum(2025,8,22,3,30,0)- 678942;   % 22 Aug 04:16 (2 horas)
...
%    s.SizeData = 75;
 ...
 h = gobjects(length(x)-1,1); % pré-alocar array para handles
    ...
    if resp == -1 % volta para o plot anterior
    ...
    elseif resp == 0 % apaga o plot do arquivo atual
        % apaga corretamente
        if ~isempty(h_store{i})
            delete(h_store{i})
            h_store{i} = [];
        ...
        i = i + 1; % avança para o próximo arquivo
